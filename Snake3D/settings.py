"""
Django settings for Snake3D project.
...
SECRET_KEY = '6-+xbq!sy5=updwy&tbz0lkm3wq2sn5*op)!fqijct+k=atslb'
...
WSGI_APPLICATION = 'Snake3D.wsgi.application'
